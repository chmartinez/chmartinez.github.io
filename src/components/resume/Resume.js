                ...
                <section id='work'>
                        ...
                        <div className='item display' style={{ opacity: 1 }}>
                            <ul className='highlights'>
                                ...
                                <li>
                                    ...
                                    hypotheses/problems worth solving
                                </li>
                                <li>
                                    Defining the product roadmap and
                                    prioritizing the backlog work of the
                                    technical team
                                </li>
                                <li>
                                    Aligning both Discovery and Delivery teams
                                    to make sure they understand the &#x27;why
                    ...
                    <div className='work-experience'>
                        ...
                        >
                            <ul className='highlights'>
                                <li>
                                    Implemented changes on products related to
                                    FREE NOW Driver Registration and internal
                                    tooling using React, Redux,
                                    styled-components, and react-testing-lib
                                </li>
                                <li>
                                    Implemented changes on an internal reusable
                                    components library used by several tools
                                    across the company
                                </li>
                                <li>
                                ...
                                <li>
                                    Provided mentoring, guidance, and support
                                    for junior developers in good testing
                                    practices, including unit, integration, and
                                    E2E tests.
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className='work-experience'>
                        <header>
                            ...
                            <div className='position'>
                                Senior Frontend Engineer | Web UI Team Leader
                                for
                            </div>
                        ...
                        >
                            <ul className='highlights'>
                                <li>
                                    Managed and mentored a remote team of four
                                    Web UI developers
                                </li>
                                <li>
                                    Led the Web UI team through sprints to
                                    deliver features requested by ESPN in the
                                    agreed timeline
                                </li>
                                <li>
                                ...
                                <li>
                                    Implemented code changes in the product
                                    using React, Mobx and Next as base UI
                                    technologies
                                </li>
                                <li>
                                    Participated in the architecture, pattern,
                                    and code styles throughout the main product
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div className='work-experience'>
                        ...
                        >
                            <ul className='highlights'>
                                <li>
                                    Performed full-stack development on two
                                    projects (CocoBongo.com rebuild and
                                    CocoBongo Entrance Checker app) with
                                    Javascript, AngularJS, Ionic, C#, and SQL
                                    using TDD techniques.
                                </li>
                                <li>
                                    Implemented Cocobongo&#x27;s new tracking
                                    system for buyer experience optimization
                                    with AngularJS and Google Analytics
                                </li>
                                <li>
                                    Implemented customer design changes across
                                    the entire UI of the project.
                                </li>
                                <li>
                                    Defined and implemented new features/A-B
                                    testings for the website that improved
                                    Google AdWords campaigns investment
                                </li>
                                <li>
                                    Using Google Analytics to analyze
                                    interaction and web site usage across the
                                    project
                                </li>
                                <li>
                                    Implemented/maintained full backend code in
                                    C# (API coding/integrations and SQL DB
                                    schema)
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className='work-experience'>
                        ...
                        >
                            <ul className='highlights'>
                                <li>
                                    Implemented new features using Web
                                    development languages (HTML5, CSS, and
                                    Javascript) for multiple projects across the
                                    company, with extensive browser support
                                    (Internet Explorer 8 and above) for mobile,
                                ...
                                <li>
                                    ...
                                    across all the company products by
                                    implementing changes on the frontend
                                    infrastructure in a rapid-development
                                    environment
                                </li>
                                <li>
                                    Included analytics events to UI components
                                    in order to track user behavior
                                </li>
                                <li>
                                    Collaborated with the Backend team in
                                    features E2E, API&#x27;s definitions and
                                    testing
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className='work-experience'>
                        ...
                        >
                            <ul className='highlights'>
                                <li>
                                    Developed End to end Android + Web App proof
                                    the concept for an e-commerce service on the
                                    Tizen OS, featuring location based behavior.
                                </li>
                                <li>
                                    Implementing code using technologies in both
                                    backend (nodejitsu, nodes, sailsjs) and
                                    frontend (bootstrap, angularjs, leaflet)
                                </li>
                                <li>
                                    Developed some of the android screens as
                                    embedded (webkit) HTML angularjs backend
                                    served pages
                                </li>
                                <li>
                                    Participated in projects related to
                                    eCommerce platforms, open-source initiatives
                                    (Openstack, and client-side applications)
                                </li>
                                <li>
                    ...
                    <div className='work-experience'>
                        ...
                        >
                            <ul className='highlights'>
                                <li>
                                    Performed development task on a Windows
                                    client application (based on C++ and
                                    Javascript)
                                </li>
                                <li>
                                ...
                                <li>
                                    Participated as security development
                                    contact, learning and following security
                                    procedures that assured the security level
                                    of the product.
                                </li>
                                <li>
                                    Promoted to Semi-Senior Software Engineer
                                    after excelling in both soft (got a
                                    &#x27;Discipline Role Mode&#x27; award from
                                    the company) and hard skills (software
                                    development in C++).
                                </li>
                            </ul>
                        </div>
